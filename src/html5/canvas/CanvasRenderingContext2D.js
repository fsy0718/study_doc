...
CanvasRenderingContext2D.prototype = {
   ...
   * 绘制每一条线段末端的属性，[ butt | round | square]
   - [lineCap 实例](../../example/html5/canvas/CanvasRenderingContext2D/line/lineCap.html)
   * @default 'butt'
   * @type {String}
   */
  lineCap: 'butt',
   ...
   * 用来设置2个长度不为0的相连部分（线段，圆弧，曲线）如何连接在一起的属性（长度为0的变形部分，其指定的末端和控制点在同一位置，会被忽略） ['miter' | 'round' | 'bevel']
   - [lineJoin 实例](../../example/html5/canvas/CanvasRenderingContext2D/line/lineJoin.html)
   * @default 'miter'
   * @type {String}
   */
  lineJoin: 'miter',
